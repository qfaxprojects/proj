...
public class Lidar_direcional : MonoBehaviour
{
    ...
    private InputAction _arma1;
    private InputAction _arma2;
    ...
    private void Awake()
    {
        ...
        _arma1 = InputSystem.actions.FindAction("Arma1");
        _arma2 = InputSystem.actions.FindAction("Arma2");
    ...
    private void Scan()
    {
        ...
        */
        ...
        if (_fire.IsPressed() && _animator.GetBool("isLooking"))
        {
            /*
